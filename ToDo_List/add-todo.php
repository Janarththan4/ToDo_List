                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="e.g: Web Programming Assignment" value="<?php if (isset($_POST["addTodo"])) { 
                                    echo $_POST["title"];
                                    }?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="desc" class="form-label">Description</label>
                                <textarea class="form-control" id="desc" name="desc" rows="3" value="<?php if (isset($_POST["addTodo"])) { 
                                    echo $_POST["title"];
                                    }?>" required></textarea>
                            </div>
                            <div>
